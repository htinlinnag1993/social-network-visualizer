            ...
            <div>
                ...
                <div className="parallax-container" style={{ height: "200px" }}>
                    <div className="parallax" style={{ position: "static", opacity: "0.5"}}>
                        <img alt="Background-1" src="/resources/images/depositphotos_71076955-stock-illustration-communication-social-banner-edited.jpg" />
                    </div>
                </div>
                <div className="section black white-text">
                    <div className="row container">
                        <div className="col s12 m12 l12 center">
                            <img alt="Concept" className="white" src="/resources/images/noun_Idea_2900895_By_Toli_DE.png" style={{ borderRadius: "50%", marginTop: "35px" }} />
                ...
                <div className="parallax-container" style={{ height: "200px" }}>
                    <div className="parallax" style={{ position: "static", opacity: "0.5" }}>
                        <img alt="Background-2" src="/resources/images/ryoji-iwata-unsplash-edited.jpg"/>
                    </div>
                </div>
                <div className="section black white-text">
                    <div className="row container">
                        <div className="col s12 m12 l12 center">
                            ...
                            <div className="row">
                                <div className="col s12 m4 l4 center">
                                    <img alt="Structure & User" className="white" src="/resources/images/noun_networking_2146368_By_Becris.png" style={{ borderRadius: "50%", marginTop: "35px" }} />
                                ...
                                <div className="col s12 m4 l4 center">
                                    <img alt="Criminal Connection" className="white" src="/resources/images/noun_Law Enforcement_1061250_By_Symbolon_IT.png" style={{ borderRadius: "50%", marginTop: "35px" }} />
                                ...
                                <div className="col s12 m4 l4 center">
                                    <img alt="Characters" className="white" src="/resources/images/noun_house targaryen_2548456_By_Luis_Herrera.png" style={{ borderRadius: "50%", marginTop: "35px" }} />
                ...
                <div className="parallax-container" style={{ height: "200px" }}>
                    <div className="parallax" style={{ position: "static", opacity: "0.5"}}>
                        <img alt="Background-3" src="/resources/images/alina-grubnyak-unsplash-edited.jpg" />
                    </div>
                </div>
                <div className="section black white-text">
                    <div className="row container">
                        <div className="col s12 m12 l12 center">
                            ...
                            <div className="row">
                                <div className="col s12 m4 l4 center">
                                    <img alt="Interactive Graph" className="white" src="/resources/images/noun_social network_1151373_By_Guilhem_FR.png" style={{ borderRadius: "50%", marginTop: "35px" }} />
                                ...
                                <div className="col s12 m4 l4 center">
                                    <img alt="Adjustable Display" className="white" src="/resources/images/noun_Adjustment Settings_1452071_Berkah Icon_ID.png" style={{ borderRadius: "50%", marginTop: "35px" }} />
                                ...
                                <div className="col s12 m4 l4 center">
                                    <img alt="Connection Finder" className="white" src="/resources/images/noun_Location_961270_By_Drishya.png" style={{ borderRadius: "50%", marginTop: "35px" }} />
                ...
                <div className="parallax-container" style={{ height: "200px" }}>
                    <div className="parallax" style={{ position: "static", opacity: "0.7"}}>
                        <img alt="Background-4" src="/resources/images/anastasia-dulgier-unsplash-edited.jpg" />
                    </div>
                </div>
                <div className="section black white-text">
                    <div className="row container">
                        <div className="col s12 m12 l12 center">
                            ...
                            <div className="row">
                                <div className="col s12 m4 l4 center">
                                    <img alt="Sign In with Google" className="white" src="/resources/images/Google_Official.png" style={{ borderRadius: "50%", marginTop: "35px" }} />
                                ...
                                <div className="col s12 m4 l4 center">
                                    <img alt="Customizable Graph" className="white" src="/resources/images/noun_Network_317687_By_Robin Richards_GB.png" style={{ borderRadius: "50%", marginTop: "35px" }} />
                                ...
                                <div className="col s12 m4 l4 center">
                                    <img alt="Demographics" className="white" src="/resources/images/noun_Demographic Data_2301706_HAlbertoGongora_CO.png" style={{ borderRadius: "50%", marginTop: "35px" }} />
